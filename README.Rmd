...
- add references, depression spikes, anxiety spikes
- make decision about terminology of argument and variable names
- think about adding treatment phases, this would mean checking that `time_spike` and `time_improvement` fall in the same specified treatment phase
